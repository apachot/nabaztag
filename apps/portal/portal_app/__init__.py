...
def create_app() -> Flask:
    ...
    app.config.update(
        ...
        NABAZTAG_VL_PING_SERVER=os.getenv("NABAZTAG_VL_PING_SERVER", "dev.emotia.com"),
        ...
        NABAZTAG_VL_XMPP_ALT_SERVER=os.getenv("NABAZTAG_VL_XMPP_ALT_SERVER", "dev.emotia.com"),
